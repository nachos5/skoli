...
// play function
Rock.prototype.splitSound = function() {
  audioManager.playAudio(audioManager.bufferArr["rockSplit"], 0.4);
}
Rock.prototype.evaporateSound = function() {
  audioManager.playAudio(audioManager.bufferArr["rockEvaporate"], 0.4);
}
